...
function Home() {
  ...
  return (
    <div>
      <section className="hero is-fullheight" style={heroStyle}>
        <div className="hero-body">
          <div className="container">
            <h1 className="title is-1 has-text-white is-italic is-overlay">
      ...
      <p className="content is-medium is-italic column has-text-dark is-fouth-fifth">
        {" "}
        At CareVillage, we are committed to providing a dynamic and inclusive
        platform designed to meet the diverse needs of parents, caregivers, and
        children. Our app offers a range of features and services to support and
        ...
        <div className="columns">
          ...
          <div className="column is-half">
            ...
            <p className="content is-medium is-italic pt-3 mt-3 mr-6 has-text-dark">
              Connect with a thriving community of parents, grandparents,
              guardians, and loved ones. Our forums are a safe and welcoming
              space to share experiences, seek advice, and engage in meaningful
              conversations about various parenting methods and challenges.
              Access a wealth of parenting resources, articles, and expert
              advice to help you make informed decisions and navigate the ups
      ...
      <div className="block">
        <div className="columns">
          <div className="column is-half">
            <p className="title has-text-primary mt-6 pt-6">
              Village Donations:
            </p>
            <p className="content is-medium is-italic pt-3 mt-3 ml-6 has-text-dark">
              Make a positive impact on the lives of children in need. Our
              dedicated donation section allows you to give back to the
              community by contributing essential items, toys, books, and
              educational resources. Together, we can create a brighter future
              for every child.
            </p>
          </div>
        ...
        <div className="columns mt-6 pt-6">
          <div className="column is-one-third has-background-info card">
            <p className="title has-text-primary">Community:</p>
            <p className="content is-medium is-italic column has-text-dark">
              Join our thriving community in our forums and uncover a treasure
              trove of knowledge, shared experiences, and expert advice, all at
              your fingertips.
            </p>
          ...
          <div className="column is-one-third has-background-success card">
            ...
            <p className="content is-medium is-italic column has-text-dark">
              At CareVillage, experience the power of community, knowledge, and
              generosity. Together, we can build a supportive and caring
              environment where every parent and child can thrive.
            </p>
              <div className="is-flex is-justify-content-center pt-1 mb-3">
                <SignUp />
              </div>
          </div>

          <div className="column is-one-third has-background-info card">
            <p className="title has-text-primary">About Us:</p>
            <p className="content is-medium is-italic column has-text-dark">
              Meet Our Diverse Team: Learn about our mission statement, what we
              offer, the unique backgrounds and skills that make our engineering
              team stand out.
            </p>
              <div className="is-flex is-justify-content-center mb-3">
                <button className="button is-primary is-rounded has-text-weight-bold">
      ...
      <section className="hero is-small is-info is-warning pb-3">
        <div className="hero-body">
          <div className="container has-text-centered">
            ...
            <div className="container">
              <h1 className="title is-3 has-text-white is-italic mb-5">
                "Where Care Comes Full Circle"
              </h1>
            </div>
            <h2 className="title is-4 has-text-danger">Make a Donation!</h2>

            <button className="button is-primary is-rounded ml-2 has-text-weight-bold">
              {" "}
              <Link
                to="/donations"
